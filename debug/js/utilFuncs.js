  ...
  async function projectPoint(pt, div){
    ...
    function(webMercatorUtils, SpatialReference, ProjectParameters, GeometryService) {
        ...
        if (myPrj === "mercator") {
          ...
          if (myPrj !== "32613") alert("Unknown projection in IdentifyWidget.xml file of "+myPrj+". dd or 32613 are the only allowed projections. Change this in js/identify.js.","Data Error");
